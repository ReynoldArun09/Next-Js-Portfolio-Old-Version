...
export const Skills = [
  { title: "Html", icon: <AiFillHtml5 size={30} /> },
  { title: "Css", icon: <DiCss3Full size={30} /> },
  { title: "Javascript", icon: <IoLogoJavascript size={30} /> },
  { title: "Scss", icon: <BsFiletypeScss size={30} /> },
  { title: "Bootstrap", icon: <BsBootstrap size={30} /> },
  { title: "Tailwind", icon: <SiTailwindcss size={30} /> },
  { title: "React", icon: <DiReact size={30} /> },
  { title: "Node", icon: <FaNodeJs size={30} /> },
